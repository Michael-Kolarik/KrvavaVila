...
kostka = Kostka(20)
hadanka = "\'Dobrý den, jsem mluvící učebnice,\' promluvil předmět, \'už zbývá jen jedna otázka. Kolik\n rovnostranných trojúhelníků lze vyrobit z šesti celých stejných zápalek?\'"
...
Kuchar_zombie = Zombie("Zombie kuchaře", 1, 8, 6, 22, -2, kostka, kuchar_utok)
Guvernantka_zombie = Zombie("Zombie guvernantky", 1, 8, 6, 22, -2, kostka, guvernantka_utok)
Sluha_zombie = Zombie("Zombie sluhy", 1, 8, 6, 22, -2, kostka, sluha_utok)
Sluzka_zombie = Zombie("Zombie služky", 1, 8, 6, 22, -2, kostka, sluzka_utok)
Majitel_zombie = Zombie("Zombie lorda", 1, 8, 6, 22, -2, kostka, lord_utok)
Dcera_zombie = Zombie("Zombie holčičky", 1, 8, 6, 22, -2, kostka, dcera_utok)
...
ochoz_loznice_lady = Dvere(Ochoz, Loznice_lady, "dveře v protější zdi vlevo",dvere_loznice_lady, Mezzobran)
